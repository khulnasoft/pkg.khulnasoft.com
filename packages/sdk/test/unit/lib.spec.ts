...
describe('openProjectId', () => {
  test('calls window.open', () => {
    ...
    openProjectId('js');
    expect(openSpy).toBeCalledWith('https://khulnasoft.com/edit/js', '_blank');
...
describe('openGithubProject', () => {
  test('calls window.open', () => {
    ...
    openGithubProject('khulnasoft/sdk');
    expect(openSpy).toBeCalledWith('https://khulnasoft.com/github/khulnasoft/sdk', '_blank');

    openGithubProject('khulnasoft/docs', { newWindow: false, hideExplorer: true });
    expect(openSpy).toBeCalledWith(
      'https://khulnasoft.com/github/khulnasoft/docs?hideExplorer=1',
      '_self'
    );
