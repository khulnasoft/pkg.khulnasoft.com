...
export interface Project {
  ...
  description?: string;
  /**
   * The project’s template name tells KhulnaSoft how to compile and run project files.
   *
   * Template values supported on https://khulnasoft.com include:
  ...
  /**
   * @deprecated Tags are ignored by the KhulnaSoft SDK since v1.5.4
   */
  tags?: string[];
}
...
export interface ProjectOptions {
  ...
  /**
   * Set the origin URL of your KhulnaSoft EE server.
   *
   * Defaults to `https://khulnasoft.com`.
   */
  origin?: string;
  /**
...
export interface EmbedOptions extends ProjectOptions {
   ...
   *
   * @see https://blog.khulnasoft.com/posts/cross-browser-with-coop-coep/
   */
