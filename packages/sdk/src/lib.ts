...
/**
 * Get a VM instance for an existing KhulnaSoft project iframe.
 */
...
/**
 * Open an existing KhulnaSoft project in a new tab (or in the current window).
 */
...
/**
 * Embeds an existing KhulnaSoft project on the current page.
 *
 * Returns a promise resolving to a VM instance.
 */
...
function _embed(elementOrId: string | HTMLElement, options?: EmbedOptions) {
