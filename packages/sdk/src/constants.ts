...
declare var __KHULNASOFT_SERVER_ORIGIN__: string | undefined;

/**
 * Origin of the khulnaSoft instance
 */
export const DEFAULT_ORIGIN: string = __KHULNASOFT_SERVER_ORIGIN__ || 'https://khulnasoft.com';
