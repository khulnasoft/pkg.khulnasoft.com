...
var logger = createScopedLogger("pkg-khulnasoft");
    ...
    publish: () => {
      return {
        args: {
          ...
          template: {
            type: "string",
            description: "generate stackblitz templates out of directories in the current repo with the new built packages"
          },
          comment: {
            type: "string",
        ...
        run: async ({ args }) => {
          ...
          const selectedPackageManager = args.packageManager;
              ...
              if (name.startsWith("package:")) {
                ...
                for (let i2 = 0; i2 < totalChunks; i2++) {
                  ...
                  if (!uploadMultipartRes.ok) {
                    ...
                    logger.error(`Error uploading part ${i2 + 1}: ${errorText}`);
                    break;
                  }
