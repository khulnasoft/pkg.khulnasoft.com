import { abbreviateCommitHash } from "@pkg-khulnasoft-com/utils";
...
export default eventHandler(async (event) => {
  ...
  for (const { key } of objects) {
    // bucket:package:stackblitz-labs:pkg.khulnasoft.com:ded05e838c418096e5dd77a29101c8af9e73daea:playground-b
