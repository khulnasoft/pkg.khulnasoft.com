...
import { isWhitelisted } from "@pkg-khulnasoft-com/utils";
...
export default eventHandler(async (event) => {
  ...
  if (!(await workflowsBucket.hasItem(workflowKey))) {
    throw createError({
      statusCode: 401,
      message:
        "Try doing multipart uploads from a github workflow! Also make sure you install https://github.com/apps/pkg-khulnasoft-com GitHub app on the repo",
    });
  }
